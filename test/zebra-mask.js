...
const { maskParts } = require('../public/animals/zebra/shape');

const templatePath = path.join(__dirname, '..', 'public', 'animals', 'zebra', 'template.svg');
...
console.log('Zebra mask test passed');
